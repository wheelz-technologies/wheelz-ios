...
open class BWSwipeCell:UITableViewCell {
    ...
    open func handlePanGesture(_ panGestureRecognizer: UIPanGestureRecognizer) {
        ...
        if panGestureRecognizer.state == .began && panGestureRecognizer.numberOfTouches > 0  && panOffset < 0{
            ...
            if panGestureRecognizer.state == .changed && panGestureRecognizer.numberOfTouches > 0 && panOffset < 0 {
